...
public class ManJianZheKouExecutor extends AbstractExecutor
    ...
    public SettlementInfo computeRule(SettlementInfo settlement) {
        ...
        for (SettlementInfo.CouponAndTemplateInfo ct :
            ...
            if (CouponCategory.isExist(ct.getTemplate().getCategory()) ==
                    CouponCategory.DOLLAR_DISCOUNT_WITH_LIMITATION) {
                manJian = ct;
            } else {
                zheKou = ct;
            }
